...
## Подробное описание
Проект — фронтенд на Next.js (App Router), реализует интерфейс для создания заданий генерации видео, просмотра результатов и управления публикацией. Интеграция публикации ориентирована на VK Clips.

## Текущий статус
- Реализован фронтенд (UI, страницы, базовая навигация)
- Интеграция VK Clips — в работе (MVP: генерация видео → публикация)
