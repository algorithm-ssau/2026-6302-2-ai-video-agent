...
- **Changelog** — история изменений (placeholder)
...
## Changelog
История изменений будет в `CHANGELOG.md` (по мере разработки).
...
- Для задач по UI добавляйте скриншоты и steps to reproduce.
...
- Настроить CI и базовый `CHANGELOG.md`.

---

Если хотите, могу сразу:
- добавить `prd/prd.md` и `PROJECT_PLAN.md`,
- или сделать шаблон для `CHANGELOG.md`.
